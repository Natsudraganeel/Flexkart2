...
<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
  ...
  <div className="dropdown-content">
 {
  categories.map((c)=>{
    return (
  <>
    <NavLink to = {`/category/${c.slug}`}  className="dropdown-item block py-2 px-3 text-gray-900  hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">{c.name}</NavLink>
    </>   )})
 }
  </div>
</div>
